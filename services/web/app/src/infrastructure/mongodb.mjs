...
export const db = {
  ...
  researchkitMemory: internalDb.collection('researchkitMemory'),
  researchkitConversations: internalDb.collection('researchkitConversations'),
  researchkitConfig: internalDb.collection('researchkitConfig'),
}
