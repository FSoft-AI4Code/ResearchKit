...
from researchkit.literature.arxiv_client import search_arxiv
from researchkit.literature.models import Author, Paper
from researchkit.literature.openalex_client import search_openalex
from researchkit.literature.semantic_scholar import search_semantic_scholar
...
def _cache_api() -> tuple[CacheGet, CachePut]:
    cache_mod = importlib.import_module("researchkit.literature.cache")
        ...
        try:
            if src_lower == "openalex":
                papers = search_openalex(
                    ...
                    limit=limit,
                    year_min=year_min,
                    email=openalex_email or "researchkit@users.noreply.github.com",
                )
